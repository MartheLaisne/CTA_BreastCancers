...
ggplot(data = data, aes(x = (HORMAD1), y = (CT83), shape = type  ))+
  geom_jitter(size = 3, color = "black", na.rm = T) + 
...
sampleTable <- Factor_H_CT[id_basal,]
sampleTable <- sampleTable[ match(colData(BRCA_basal_counts)$paper_patient, sampleTable$patient  ), ]
